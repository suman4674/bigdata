...
// set up chart .select('#rpm').append("svg")
var svgCC = d3.select('#cc').append("svg").attr("width", width).attr("height", height);
var chartCC = d3.select('#cc').select("svg");
...
chartCC.append('g').call(yAxis)
    .attr('transform', 'translate(' + (width - margin.axis) + ', 0)');
	
chartCC.append('g').call(xAxis)
